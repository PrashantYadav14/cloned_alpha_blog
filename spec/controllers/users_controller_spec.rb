...
RSpec.describe UsersController, type: :controller do
  ...
  describe "GET #show" do
    it "should get to show template of particluar user" do
  ...
  describe "GET #new" do
    it "should get to new template" do
      get :new
      expect(response).to have_http_status(:success)
    end
  end
  describe "POST #create" do
    ...
    describe "GET #edit" do
      context "when user profile is of current logged in user" do
          before do
      ...
      context "when user is editing someone else profile" do
        before do
